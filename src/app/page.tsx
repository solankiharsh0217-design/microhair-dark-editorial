...
function Hero() {
  return (
    <section className="relative min-h-[100svh] overflow-hidden pt-28 md:pt-32">
      ...
      <div className="relative mx-auto grid max-w-[1500px] grid-cols-1 gap-10 px-5 pb-12 md:px-10 lg:grid-cols-12 lg:gap-8 lg:pb-24">
        {/* Top eyebrow row */}
        ...
        <div className="col-span-1 lg:col-span-8">
          ...
          <ScrollReveal delay={200}>
            <div className="mt-10 flex max-w-xl flex-col gap-6 md:flex-row md:items-start md:gap-8">
        ...
        <div className="col-span-1 lg:col-span-4">
          <ScrollReveal delay={400}>
            <div className="relative aspect-[3/4] w-full overflow-hidden border border-line bg-surface">
              ...
              <div className="absolute left-0 top-0 m-5 flex items-center gap-2 rounded-full border border-cream/20 bg-ink/60 px-3 py-1.5 backdrop-blur-md">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 md:p-7">
                <p className="eyebrow-muted">N° 01 / Volume</p>
                <p className="display mt-2 text-2xl text-cream md:text-3xl">
                  The shaved-<em className="italic text-gold">head</em> effect, perfected.
                </p>
              </div>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={550}>
            <div className="mt-5 flex items-center justify-between border-t border-line pt-4 text-[11px] text-muted-2">
              <span className="num-mono tracking-widest">PHOTO · MAKETABLE</span>
        ...
        <div className="col-span-1 mt-6 hidden items-end justify-between lg:col-span-12 lg:mt-12 lg:flex">
...
function Marquee() {
  ...
  return (
    <section className="relative border-y border-line bg-ink py-5">
...
function Method() {
  return (
    <section id="metodo" className="relative border-b border-line py-24 md:py-36">
      <div className="mx-auto max-w-[1500px] px-5 md:px-10">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <ScrollReveal>
              <p className="eyebrow">— 02 · Il Metodo</p>
              <h2 className="display mt-5 text-5xl leading-[0.95] text-cream md:text-6xl">
            ...
            <ScrollReveal delay={150}>
              <p className="mt-8 max-w-md text-sm leading-relaxed text-cream-dim md:text-base">
          ...
          <div className="space-y-8 lg:col-span-8 lg:pl-12">
            {PILLARS.map((p, i) => (
              <ScrollReveal key={p.n} delay={i * 120}>
                <article className="group grid grid-cols-12 gap-6 border-t border-line pt-8">
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
              {STATS.map((s, i) => (
                <div key={s.k} className="group">
                  ...
                  <p className="display mt-3 text-5xl text-cream transition-colors group-hover:text-gold md:text-6xl">
                    {s.v}
                  </p>
...
function Excellence() {
  return (
    <section id="eccellenza" className="relative overflow-hidden border-b border-line py-24 md:py-36">
        ...
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-12 lg:gap-16">
          ...
          <ScrollReveal className="lg:col-span-5">
            <div className="relative">
              ...
              <div className="mt-5 flex items-center justify-between text-[11px] text-muted-2">
                <span className="num-mono tracking-widest">LUCA SAGONA · 2024</span>
                <span className="num-mono tracking-widest">PHOTO · 35MM</span>
              </div>

              {/* Floating gold card */}
              <div className="absolute -right-4 top-1/2 hidden -translate-y-1/2 rotate-3 border border-gold/30 bg-ink/90 p-5 shadow-gold backdrop-blur-md md:block">
                <Award className="h-5 w-5 text-gold" />
                <p className="num-mono mt-3 text-[9px] tracking-[0.3em] text-gold">CERTIFIED ARTIST</p>
                <p className="display mt-1 text-sm leading-tight text-cream">
          ...
          <div className="lg:col-span-7 lg:pl-8">
            <ScrollReveal>
              ...
              <h2 className="display mt-5 text-5xl leading-[0.95] text-cream md:text-7xl">
                Incontra
                <br />
            ...
            <ScrollReveal delay={150}>
              <div className="mt-10 space-y-6 text-base leading-relaxed text-cream-dim md:text-lg">
                ...
                <p>
                  ...
                  firma: lavoro rigoroso, sopracciglia definite con matematica, pigmenti calibrati sul
            ...
            <ScrollReveal delay={250}>
              <div className="mt-10 grid grid-cols-1 gap-4 border-y border-line py-8 sm:grid-cols-2">
                {[
                  ...
                  <div key={it.meta} className="flex items-center gap-4">
...
function Process() {
  return (
    <section id="processo" className="relative border-b border-line py-24 md:py-36">
      <div className="mx-auto max-w-[1500px] px-5 md:px-10">
        <div className="mb-16 grid grid-cols-1 gap-8 lg:grid-cols-12">
          <div className="lg:col-span-6">
            <ScrollReveal>
              <p className="eyebrow">— 04 · Il Processo</p>
              <h2 className="display mt-5 text-5xl leading-[0.95] text-cream md:text-6xl">
                Quattro atti,
                <br />
        ...
        <div className="space-y-0">
          {PROCESS.map((p, i) => (
            <ScrollReveal key={p.n} delay={i * 80}>
              <article
                className={`group grid grid-cols-12 gap-6 border-t border-line py-10 transition-colors hover:bg-surface/30 md:gap-8 ${
              ...
              >
                ...
                <div className="col-span-9 md:col-span-6">
                  ...
                  <p className="mt-4 max-w-xl text-sm leading-relaxed text-cream-dim md:text-base">
                    {p.body}
                  </p>
                </div>
...
function Results() {
  const cases = [
    { src: "/images/case-1.png", title: "Ricostruzione frontale", meta: "Studio · 3 sedute" },
    { src: "/images/case-2.png", title: "Copertura vertex", meta: "Studio · 2 sedute" },
    { src: "/images/case-3.png", title: "Densità post-trapianto", meta: "Su appuntamento" },
  ];

  return (
    <section id="risultati" className="relative border-b border-line py-24 md:py-36">
      <div className="mx-auto max-w-[1500px] px-5 md:px-10">
        <div className="mb-16 grid grid-cols-1 gap-8 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <ScrollReveal>
              <p className="eyebrow">— 05 · Risultati</p>
              <h2 className="display mt-5 text-5xl leading-[0.95] text-cream md:text-7xl">
              ...
              <article className="group cursor-pointer">
                <div className="relative aspect-[4/5] overflow-hidden border border-line bg-surface">
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-5">
                    ...
                    <h3 className="display mt-2 text-2xl text-cream md:text-3xl">
                      {c.title}
                    </h3>
                    <p className="mt-1 text-xs text-cream-dim">{c.meta}</p>
                  </div>
                  <div className="absolute right-4 top-4 flex h-9 w-9 items-center justify-center rounded-full border border-cream/20 bg-ink/60 text-cream opacity-0 backdrop-blur-md transition-opacity group-hover:opacity-100">
        ...
        <ScrollReveal delay={300}>
          <div className="mt-16 grid grid-cols-1 gap-6 border-t border-line pt-12 md:grid-cols-3">
            {[
              ...
              <div key={b.n} className="group flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-cream-dim">{b.d}</p>
                </div>
              </div>
            ))}
          </div>
    ...
    <section className="relative border-b border-line py-24 md:py-36">
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 md:px-10">
        <div className="mb-16 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <ScrollReveal>
            <div>
              <p className="eyebrow">— 06 · Voci</p>
              <h2 className="display mt-5 max-w-3xl text-5xl leading-[0.95] text-cream md:text-6xl">
                Cosa dicono
                <br />
          ...
          <ScrollReveal delay={150}>
            <div className="flex items-center gap-2 text-sm text-cream-dim">
              ...
              <span className="num-mono ml-2 text-cream">{SITE.rating}</span>
              <span className="text-muted-2">/ 5 · {SITE.reviewCount} recensioni</span>
            </div>
          </ScrollReveal>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {TESTIMONIALS.map((t, i) => (
            <ScrollReveal key={t.name} delay={i * 120}>
              <article className="relative flex h-full flex-col border border-line bg-surface/40 p-7 transition-all hover:border-gold/40 hover:bg-surface">
                <Quote className="h-7 w-7 text-gold/40" />
                <p className="display mt-5 flex-1 text-xl leading-snug text-cream md:text-2xl">
      ...
      <div className="mx-auto max-w-[1500px] px-5 md:px-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
          <div className="lg:col-span-5">
            <ScrollReveal>
              <p className="eyebrow">— 07 · Domande</p>
              <h2 className="display mt-5 text-5xl leading-[0.95] text-cream md:text-6xl">
                Tutto quello che
                <br />
              ...
              <a
                href="#contatti"
                className="group mt-8 inline-flex cursor-pointer items-center gap-2 text-sm font-medium text-gold"
              >
                <span className="border-b border-gold/40 pb-0.5 group-hover:border-gold">
...
function FAQItem({ q, a, n }: { q: string; a: string; n: number }) {
  return (
    <details className="group border-b border-line [&_summary::-webkit-details-marker]:hidden">
      <summary className="flex cursor-pointer items-start gap-6 py-6 transition-colors hover:text-gold">
      ...
      <div className="grid grid-cols-12 gap-6 pb-6">
        ...
        <p className="col-span-12 max-w-2xl text-base leading-relaxed text-cream-dim md:col-span-10">
          {a}
        </p>
      </div>
    </details>
    ...
    <section className="relative overflow-hidden py-24 md:py-36">
      ...
      <div className="relative mx-auto max-w-[1500px] px-5 md:px-10">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              <p className="eyebrow">— 08 · Cosa stai aspettando?</p>
              <h2 className="display mt-5 text-5xl leading-[0.95] text-cream md:text-7xl">
                Compila il modulo.
                <br />
            ...
            <form className="mt-12 space-y-6">
              ...
              <div>
                <label className="eyebrow-muted mb-3 block">La tua situazione</label>
                <select
              ...
              <div>
                <label className="eyebrow-muted mb-3 block">Quando preferisci essere ricontattato?</label>
              ...
              <div>
                <label className="eyebrow-muted mb-3 block">Messaggio (opzionale)</label>
                <textarea
                  rows={4}
          ...
          <div className="lg:col-span-5 lg:pl-8">
            ...
            <ScrollReveal delay={250}>
              <div className="mt-10 border border-gold/30 bg-gold/5 p-7">
                <p className="eyebrow">— Garanzia</p>
                <p className="display mt-3 text-2xl text-cream">
                  Consulenza iniziale
                  <br />
                ...
                <Check className="mt-4 h-5 w-5 text-gold" />
              </div>
            </ScrollReveal>
          </div>
        </div>
...
function Field({
  ...
  return (
    <div>
      <label className="eyebrow-muted mb-3 block">{label}</label>
      <input
        type={type}
